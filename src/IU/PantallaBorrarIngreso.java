...
public class PantallaBorrarIngreso extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PantallaBorrarIngreso frame = new PantallaBorrarIngreso();
	...
	public PantallaBorrarIngreso() {
		...
		JLabel lblNewLabel = new JLabel("Borrar Ingreso");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 22));
		lblNewLabel.setBounds(128, 6, 166, 37);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("ID de Ingreso a Borrar:");
		...
		btnNewButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent arg0) {
		        if (chckbxNewCheckBox.isSelected()) {
		            try {
		                int idIngreso = Integer.parseInt(textField.getText());

		                Caja ingresos = new Caja(0,"");
		                boolean ingresoBorrado = ingresos.eliminarIngresoPorID(idIngreso);
